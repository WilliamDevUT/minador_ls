...
#Esta funcion se encarga de interpolar los keypoints a una longitud fija
...
#Esta funcion se encarga de normalizar los keypoints a una longitud fija
...
def normalize_keypoints(keypoints, target_length=15):
    ...
    if current_length < target_length:
        ...
        return keypoints
#Esta funcion se encarga de evaluar el modelo en tiempo real o con un video de entrada    
def evaluate_model(src=None, threshold=0.7, margin_frame=1, delay_frames=3):
    ...
    with Holistic() as holistic_model:
        ...
        while video.isOpened():
            ...
            if not src:
                cv2.rectangle(frame, (0, 0), (640, 35), (113, 117, 246), -1)
